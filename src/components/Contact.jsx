    ...
    <div>
      <div id="contact" className={`w-full h-full bg-[#17171B] pt-28 pb-16`}>
        <motion.h1
          ...
          className={`lg:text-4xl text-2xl w-full text-center mb-10 text-white uppercase font-sans tracking-wider bg-gradient-to-r from-pink-300 via-cyan-500 to-purple-500 bg-clip-text text-transparent`}
        >
          Location
        </motion.h1>
